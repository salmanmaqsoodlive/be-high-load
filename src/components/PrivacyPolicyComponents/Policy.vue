<template>
  <section>
    <div class="container margin-t">
      ...
      <h2 class="sub-heading">Interpretation</h2>
      <p>The words of which the initial letter is capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.</p>
      <h2 class="sub-heading">Definitions</h2>
      ...
      <ul>
        ...
        <li>
          <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to BEHIGHLOAD SPÓŁKA Z OGRANICZONĄ ODPOWIEDZIALNOŚCIĄ, UL. ADAMA BRANICKIEGO 21 / U3, 02-972 WARSZAWA.</p>
        ...
        <li>
          <p><strong>Website</strong> refers to beHighload, accessible from <a href="https://behighload.com/" rel="external nofollow noopener" target="_blank">https://behighload.com/</a></p>
        </li>
        <li>
      ...
      <h1 class="heading">Collecting and Using Your Personal Data</h1>
      <h2 class="sub-heading">Types of Data Collected</h2>
      <h3>Personal Data</h3>
      ...
      <h2 class="sub-heading">Use of Your Personal Data</h2>
      ...
      <h2 class="sub-heading">Retention of Your Personal Data</h2>
      ...
      <h2 class="sub-heading">Transfer of Your Personal Data</h2>
      ...
      <h2 class="sub-heading">Disclosure of Your Personal Data</h2>
      ...
      <h2 class="sub-heading">Security of Your Personal Data</h2>
      <p>The security of Your Personal Data is important to Us, but remember that no method of transmission over the Internet, or method of electronic storage is 100% secure. While We strive to use commercially acceptable means to protect Your Personal Data, We cannot guarantee its absolute security.</p>
      <h1 class="heading">Detailed Information on the Processing of Your Personal Data</h1>
      ...
      <h2 class="sub-heading">Email Marketing</h2>
      <p>We may use Your Personal Data to contact You with newsletters, marketing or promotional materials and other information that may be of interest to You. You may opt-out of receiving any, or all, of these communications from Us by following the unsubscribe link or instructions provided in any email We send or by contacting Us.</p>
      <p>We may use Email Marketing Service Providers to manage and send emails to You.</p>
      <ul>
        <li>
          <p><strong>Google</strong></p>
          <p>Their Privacy Policy can be viewed at <a href="https://policies.google.com/privacy?hl=en-US" rel="external nofollow noopener" target="_blank">https://policies.google.com/privacy?hl=en-US</a></p>
        </li>
      </ul>
      <h1 class="heading">GDPR Privacy</h1>
      <h2 class="sub-heading">Legal Basis for Processing Personal Data under GDPR</h2>
      ...
      <h2 class="sub-heading">Your Rights under the GDPR</h2>
      ...
      <h2 class="sub-heading">Exercising of Your GDPR Data Protection Rights</h2>
      <p>You may exercise Your rights of access, rectification, cancellation and opposition by contacting Us. Please note that we may ask You to verify Your identity before responding to such requests. If You make a request, We will try our best to respond to You as soon as possible.</p>
      <p>You have the right to complain to a Data Protection Authority about Our collection and use of Your Personal Data. For more information, if You are in the European Economic Area (EEA), please contact Your local data protection authority in the EEA.</p>
      <h1 class="heading">CCPA Privacy</h1>
      <p>This privacy notice section for California residents supplements the information contained in Our Privacy Policy and it applies solely to all visitors, users, and others who reside in the State of California.</p>
      <h2 class="sub-heading">Categories of Personal Information Collected</h2>
      ...
      <h2 class="sub-heading">Sources of Personal Information</h2>
      ...
      <h2 class="sub-heading">Use of Personal Information for Business Purposes or Commercial Purposes</h2>
      ...
      <h2 class="sub-heading">Disclosure of Personal Information for Business Purposes or Commercial Purposes</h2>
      ...
      <h2 class="sub-heading">Sale of Personal Information</h2>
      ...
      <h2 class="sub-heading">Share of Personal Information</h2>
      ...
      <h2 class="sub-heading">Sale of Personal Information of Minors Under 16 Years of Age</h2>
      ...
      <h2 class="sub-heading">Exercising Your CCPA Data Protection Rights</h2>
      <p>In order to exercise any of Your rights under the CCPA, and if You are a California resident, You can contact Us:</p>
      <ul>
        <li>By email: info@behighload.com</li>
      </ul>
      ...
      <h2 class="sub-heading">Do Not Sell My Personal Information</h2>
      ...
      <h1 class="heading">&quot;Do Not Track&quot; Policy as Required by California Online Privacy Protection Act (CalOPPA)</h1>
      <p>Our Service does not respond to Do Not Track signals.</p>
      <p>However, some third party websites do keep track of Your browsing activities. If You are visiting such websites, You can set Your preferences in Your web browser to inform websites that You do not want to be tracked. You can enable or disable DNT by visiting the preferences or settings page of Your web browser.</p>
      <h1 class="heading">Children's Privacy</h1>
      ...
      <h1 class="heading">Your California Privacy Rights (California's Shine the Light law)</h1>
      <p>Under California Civil Code Section 1798 (California's Shine the Light law), California residents with an established business relationship with us can request information once a year about sharing their Personal Data with third parties for the third parties' direct marketing purposes.</p>
      <p>If you'd like to request more information under the California Shine the Light law, and if You are a California resident, You can contact Us using the contact information provided below.</p>
      <h1 class="heading">California Privacy Rights for Minor Users (California Business and Professions Code Section 22581)</h1>
      ...
      <h1 class="heading">Changes to this Privacy Policy</h1>
