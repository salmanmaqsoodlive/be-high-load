    ...
    <div class="container margin-t">
      ...
      <ul>
        <li>
          ...
          this Cookies Policy) refers to BEHIGHLOAD SPÓŁKA Z OGRANICZONĄ
        ...
        <li>
          ...
          <a
            href="http://behighload.com/"
            rel="external nofollow noopener"
            target="_blank"
            >http://behighload.com/</a
          >
        </li>
        <li>
      ...
      <h1 class="heading">The use of the Cookies</h1>
      <h2 class="sub-heading">Type of Cookies We Use</h2>
      <p class="paragraph">
      ...
      <h2 class="sub-heading">Your Choices Regarding Cookies</h2>
      <p class="paragraph">
      ...
      <h2 class="sub-heading">More Information about Cookies</h2>
      <p class="paragraph">
